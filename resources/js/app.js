        ...
        methods:{
                ...
                axios.get('/stats/month/' + restaurantId + '/' + this.year,
                {
                    ...
                    for (let i = 0; i < monthsNames12.length; i++) {
                        ...
                        if(month == this.monthsName[cont]){
                            ordersNumberList.push(this.monthsOrders[cont]);
                            cont ++;
                        }else{
            ...
            apiChartUpdate: function (){
                axios.get('/stats/month/' + restaurantId + '/' + this.year,
                {
                    ...
                    console.log(this.monthsName, this.monthsOrders, 'API Axios 3', ordersNumberList);
                    ...
                    console.log(ordersNumberList, 'ola');
                }).catch((error) => {
                    console.log(error);
                });
            },
            ...
            updateMonthsChart: function (){
                ...
                let prova = this.apiChartUpdate();
                console.log(prova);

                this.myChart.data.labels.push(monthsNames12);
                this.myChart.data.datasets.forEach((dataset) => {
                dataset.data.push(prova);
                });
                this.myChart.update();
            }
        }
